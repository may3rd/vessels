...
interface Props {
    vessel: VerticalEllipticalVessel;
}

export const VerticalEllipticalVesselDiagram: React.FC<Props> = ({
    vessel,
}) => {
    ...
    const bottomHeadPath = `M ${-diameter / 2} 0 A ${diameter / 2} ${bottomHeadDistance} 0 0 0 ${diameter / 2} 0`;
    const topHeadPath = `M ${diameter / 2} ${length} A ${diameter / 2} ${topHeadDistance} 0 0 0 ${-diameter / 2} ${length}`;
  ...
  `;
    ...
    return (
        ...
        >
            <Defs />
            <defs>
                <clipPath id="ellipticalVesselClip">
                    <path d={vesselPath} />
                </clipPath>
            </defs>
            ...
            <rect
                ...
                fill="lightblue"
                fillOpacity={0.5}
                clipPath="url(#ellipticalVesselClip)"
            />
