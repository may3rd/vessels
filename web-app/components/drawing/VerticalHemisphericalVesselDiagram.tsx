...
interface Props {
    vessel: VerticalHemisphericalVessel;
}

export const VerticalHemisphericalVesselDiagram: React.FC<Props> = ({
    vessel,
}) => {
    ...
    const bottomHeadPath = `M ${-diameter / 2} 0 A ${diameter / 2} ${diameter / 2} 0 0 0 ${diameter / 2} 0`;
    const topHeadPath = `M ${diameter / 2} ${length} A ${diameter / 2} ${diameter / 2} 0 0 0 ${-diameter / 2} ${length}`;
