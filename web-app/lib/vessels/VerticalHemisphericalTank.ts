import { VerticalHemisphericalVessel } from "./VerticalHemisphericalVessel";

export class VerticalHemisphericalTank extends VerticalHemisphericalVessel {
    public readonly vesselType: string = "Vertical HemiSpherical Tank";
